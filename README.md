...
| Cameras (and status LEDs) | ❌ | Not working, but hardware fully identified (2026-08): rear OmniVision OV13858, front Sony IMX681, IR STMicroelectronics VD55G0, all on a Qualcomm Spectra 695 ISP. Two of three sensors have a mainline Linux driver to build on. Devicetree wiring not yet written. See [CAMERA.md](CAMERA.md) and [CAMERA_BRINGUP.md](CAMERA_BRINGUP.md). |
